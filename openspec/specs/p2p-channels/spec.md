# p2p-channels Specification

## Purpose
P2P signalling and connection infrastructure for real-time peer discovery and WebRTC data channels. Uses iroh-gossip for signalling and matchbox for WebRTC, enabling direct browser-to-browser connections on the same LAN.
